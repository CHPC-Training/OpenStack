...
### Private Network
To create a private network, simply click on "+ Create Network" button while in the Network Topology view. Alternatively, navigate to the "Network" --> "Networks" section on the left menu, and click on "+ Create Network" on the top right.
<p float="left">
